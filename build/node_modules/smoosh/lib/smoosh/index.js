...
var _write = {
  ...
  message: function(message) {
    if (this._flushed) {
      _config.config.quiet || console.log(message);
    } else {
  ...
  smoosh: function () {
    // this.message(' _______  _______  _______  _______  _______  _______ '.yellow);
    // this.message('|     __||   |   ||       ||       ||     __||   |   |'.yellow);
    // this.message('|__     ||       ||   -   ||   -   ||__     ||       |'.yellow);
    // this.message('|_______||__|_|__||_______||_______||_______||___|___|\n'.yellow);
  },
  ...
  noConfig: function () {
    this.newLine();
    this.message('Whoa! Something went wrong up... smoosh needs a valid config file!\n'.yellow);
  },
    ...
    who.forEach(function (who) {
      for (file in _files[who]) {
        if (who == 'JAVASCRIPT') {
          ...
          that.css_compress(file, _files[who][file]);
        }
      }
    });
  },
